...
x_train_b0 = cbind(rep(1,nrow(x_train)),scale(x_train))
x_test_b0 = cbind(rep(1,nrow(x_test)), scale(x_test))
```
...
lambda.seq = exp(seq(-1,-12, length=500))
...
NR.lasso.ans = lassoCD(x_train_b0, y_train, lambda = exp(best.lambda), init_beta = rep(0, ncol(x_train_b0)))
```
