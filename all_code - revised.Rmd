...
\begin{center} \textbf{Figure 1}. Correlation plot of all variables \end{center}
...
\begin{center} \textbf{Figure 2}. Correlation plot of after feature selection \end{center}
...
## Logitstic LASSO Coordinate Descent Algorithm
...
![Principle of k-fold CV](cv_principle.png){width=30%}
...
![log.lambda with the Largest AUC](cv_result.png){width=60%}
...
![](train_auc.png){width=100%}

\begin{center} \textbf{Figure 4}. Model Coefficient Estimated by Different Methods \end{center}


$\quad$

![](test_auc.png){width=100%}

\begin{center} \textbf{Figure 5}. Model AUCs on the Test Dataset \end{center}
