...
![Caption for the picture.](\cv_principle.png)
...
lambda.seq.lassoCD = exp(seq(-1,-14, length=1000))
...
```
```{r}
best_beta.lassoCD <- lassoCD(x_train_b0, y_train,mean(exp(best.lambda.lassoCD)), init_beta = rep(4,dim(x_train_b0)[2]))
```
