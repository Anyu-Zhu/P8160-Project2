...
logisticstuff(x2, y, rep(2, 20))
logisticstuff(x3, y, rep(2, 30))
```
...
nr1 = NewtonRaphson(x1, y, logisticstuff, rep(1,10))
nr2 = NewtonRaphson(x2, y, logisticstuff, rep(1,20))
nr3 = NewtonRaphson(x3, y, logisticstuff, rep(1,30))
```
